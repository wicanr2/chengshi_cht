...
| 比什麼 | 結果 |
|---|---|
| 編輯視窗地圖區露出來的 176 格 | **174 格逐位元相同**，剩下兩格是滑鼠游標停的位置不同 |
| City Form 視窗的外殼（外框、標題列、圖層圖示欄、網點）| **20 695／20 723 個像素相同**（99.86%），差的是關閉鈕小圖與原版那張的游標 |
...
**縮小是 remake 加的，原版沒有。** 原版的編輯視窗永遠一格 16 像素——
