...
sim Rand
sim Rand
set _m {} ; for {set y 0} {$y < 100} {incr y} { for {set x 0} {$x < 120} {incr x} { lappend _m [sim Tile $x $y] } } ; puts stdout "RA [llength $_m] [join $_m ,]"
sim Speed 3
#sleep 30
sim Speed 0
sim Year
...
sim Rand
sim Rand
set _m {} ; for {set y 0} {$y < 100} {incr y} { for {set x 0} {$x < 120} {incr x} { lappend _m [sim Tile $x $y] } } ; puts stdout "RB [llength $_m] [join $_m ,]"
