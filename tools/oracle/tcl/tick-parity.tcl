...
sim Rand
sim Rand
set _m {} ; for {set y 0} {$y < 100} {incr y} { for {set x 0} {$x < 120} {incr x} { lappend _m [sim Tile $x $y] } } ; puts stdout "MAP0 [llength $_m] [join $_m ,]"
sim Speed 3
#sleep 4
sim Speed 0
sim Funds
...
sim Rand
sim Rand
set _m {} ; for {set y 0} {$y < 100} {incr y} { for {set x 0} {$x < 120} {incr x} { lappend _m [sim Tile $x $y] } } ; puts stdout "MAP1 [llength $_m] [join $_m ,]"
sim LandValue
sim Pollution
sim Crime
